...
{
	os_panic("OSMetaClassBase::_RESERVEDOSMetaClassBase%d called.", 0);
}
void
OSMetaClassBase::_RESERVEDOSMetaClassBase1()
{
	os_panic("OSMetaClassBase::_RESERVEDOSMetaClassBase%d called.", 1);
}
void
OSMetaClassBase::_RESERVEDOSMetaClassBase2()
{
	os_panic("OSMetaClassBase::_RESERVEDOSMetaClassBase%d called.", 2);
}
#endif /* SLOT_USED */
...
{
	os_panic("OSMetaClassBase::_RESERVEDOSMetaClassBase%d called.", 3);
}
void
OSMetaClassBase::_RESERVEDOSMetaClassBase4()
{
	os_panic("OSMetaClassBase::_RESERVEDOSMetaClassBase%d called.", 4);
}
void
OSMetaClassBase::_RESERVEDOSMetaClassBase5()
{
	os_panic("OSMetaClassBase::_RESERVEDOSMetaClassBase%d called.", 5);
}
void
OSMetaClassBase::_RESERVEDOSMetaClassBase6()
{
	os_panic("OSMetaClassBase::_RESERVEDOSMetaClassBase%d called.", 6);
}
#endif
...
{
	os_panic("OSMetaClassBase::_RESERVEDOSMetaClassBase%d called.", 7);
}
#endif
...
{
	os_panic("OSMetaClass::_RESERVEDOSMetaClass%d called", 0);
}
void
OSMetaClass::_RESERVEDOSMetaClass1()
{
	os_panic("OSMetaClass::_RESERVEDOSMetaClass%d called", 1);
}
void
OSMetaClass::_RESERVEDOSMetaClass2()
{
	os_panic("OSMetaClass::_RESERVEDOSMetaClass%d called", 2);
}
void
OSMetaClass::_RESERVEDOSMetaClass3()
{
	os_panic("OSMetaClass::_RESERVEDOSMetaClass%d called", 3);
}
void
OSMetaClass::_RESERVEDOSMetaClass4()
{
	os_panic("OSMetaClass::_RESERVEDOSMetaClass%d called", 4);
}
void
OSMetaClass::_RESERVEDOSMetaClass5()
{
	os_panic("OSMetaClass::_RESERVEDOSMetaClass%d called", 5);
}
void
OSMetaClass::_RESERVEDOSMetaClass6()
{
	os_panic("OSMetaClass::_RESERVEDOSMetaClass%d called", 6);
}
void
OSMetaClass::_RESERVEDOSMetaClass7()
{
	os_panic("OSMetaClass::_RESERVEDOSMetaClass%d called", 7);
}
#endif
...
{
        // if ((0 == OSAtomicIncrement32((int32_t*)&(((OSMetaClass *) this)->instanceCount))) && superClassLink)
        if ((0 == OSAtomicIncrement32((int32_t*)&instanceCount)) && superClassLink) {
...
{
        if ((1 == OSAtomicDecrement32((int32_t*)&instanceCount)) && superClassLink) {
...
OSMetaClass::copyMetaClassWithName(const OSSymbol * name)
{
        ...
        if (sAllClassesDict) {
                meta = (OSMetaClass *) sAllClassesDict->getObject(name);
                if (meta) {
                        OSAtomicIncrement32((int32_t*)&meta->reserved->retain);
		}
	}
        IOLockUnlock(sAllClassesLock);
...
{
        OSAtomicDecrement32((int32_t*)&reserved->retain);
}
...
OSMetaClass::reservedCalled(int ind) const
{
        ...
        os_panic("%s::_RESERVED%s%d called.", cname, cname, ind);
}
...
{
        os_panic("OSMetaClass::getClassDictionary() is obsoleted.\n");
        return 0;
}
...
{
        os_panic("OSMetaClass::serialize(): Obsoleted\n");
        return false;
}
