...
#define ml_set_interrupts_enabled(s) (s)
...
void * IOLockGetMachLock( IOLock * lock);
...
pthread_mutex_t * IORecursiveLockGetMachLock( IORecursiveLock * lock);
...
pthread_rwlock_t * IORWLockGetMachLock( IORWLock * lock);
...
pthread_spinlock_t * IOSimpleLockGetMachLock( IOSimpleLock * lock);
